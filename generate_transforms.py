...
def generate_detection_train_transform(
    ...
    train_transforms = Compose(
        [
            ...
            RandAdjustContrastd(keys=[image_key], prob=0.2, gamma=(0.5, 4.5)),
            RandHistogramShiftd(keys=[image_key], prob=0.2, num_control_points=10),
            RandBiasFieldd(keys=[image_key], prob=0.2),
            RandGibbsNoised(keys=[image_key], prob=0.2, alpha=(0.0, 1.0)),
            RandKSpaceSpikeNoised(keys=[image_key], prob=0.2),
